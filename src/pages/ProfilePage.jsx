...
const ProfilePage = () => {
  ...
  const handlePhotoUpload = async (e) => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "Foto telah diperbarui dengan sukses!",
      });
    } catch (error) {
      ...
      <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-r from-emerald-600 to-emerald-500 p-10 md:p-14 text-white shadow-2xl">
        <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
          ...
          <div className="flex-1 space-y-2">
            ...
            <p className="text-[#FFFDCE]/60 font-medium">
              @{profile?.username} • Member sejak{" "}
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-gray-300 text-lg">
                      @
                    </span>
                    <input
                      readOnly
                  ...
                  {profile?.score_logs?.length > 0 ? (
                    profile.score_logs.map((log, idx) => (
                      <div key={idx} className="relative pl-8 group">
                        <div
                          className={`absolute left-0 top-1.5 w-6 h-6 rounded-full border-4 border-white shadow-sm flex items-center justify-center ${log.score_change >= 0
                              ? "bg-emerald-500"
                              : "bg-red-500"
                            }`}
                        ></div>
                        <div>
                          <div className="flex justify-between items-start">
                            ...
                            <span
                              className={`text-xs font-black ${log.score_change >= 0
                                  ? "text-emerald-600"
                                  : "text-red-500"
                                }`}
                            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center text-sm font-medium">
                  ...
                  <span className="font-mono text-emerald-400">
                    IDX-{profile?.id.toString().padStart(4, "0")}
                  </span>
                </div>
              </div>
            </div>
